...
-export([scan/1,scan/2,scan/3,scan/4]).
...
scan(File) -> scan(File,raw).
scan(File,CBs) -> scan(File,CBs,0,'').
scan(File,CBs,Seq) -> scan(File,CBs,Seq,Seq).
scan(File,CBs,Min,Max) -> sherk_scan:go(File,CBs,Min,Max).
